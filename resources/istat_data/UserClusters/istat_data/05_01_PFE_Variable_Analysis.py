...
Probablities=pd.read_csv("probs_for_isolation.csv")
...
age_th = 100   # Example threshold for age
...
#%%
formula = """
prob0 ~ age + area + I(age**2) + I(area**2) + age:area 
        + C(isolation):age
...
formula = """
prob2 ~ age + area + I(age**2)  + age:area 
...
prob3 ~ age + area + I(age**2) + I(area**2) + age:area 
        + C(isolation):age + C(isolation):area +C(isolation)
        + C(isolation):I(age**2) + C(isolation):I(area**2)
